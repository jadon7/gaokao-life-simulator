...
- 关键角色用 storyCast 身份短语；不要写“有人/某个人”。
- summary 继承上一张实际 consequence；relationshipTrack 必须用允许阶段。
...
- batch 输出质量必须和单张 annual 输出一致，不能因为预生成就省略 lifeTrack、relationshipTrack、consequence。
...
function phasePromptForYear(year = 1) {
  ...
  return "收束落点：职业定位必须明确；关系收束到结婚生子、新恋情稳定、体面告别或共同生活；不再制造小作业事故。";
}
...
function deriveDramaFields(card = {}) {
  ...
  return {
    ...
    choiceContrast: `${card.abType || "两种打法"}；A/B 必须像两种人生态度，不像两个温和建议`,
